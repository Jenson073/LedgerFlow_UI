  ...
  <div class="records-container">
    ...
    <div class="controls-bar">
      <div class="search-filter-group">
        ...
        />
        <select v-model="typeFilter" class="table-filter-select">
          <option value="All">All Types</option>
          <option value="Deposit">Deposits / Credits (+)</option>
          <option value="Withdrawal">Withdrawals / Debits (-)</option>
        </select>
      </div>
    ...
    <div class="table-responsive">
      <div v-if="loading" class="table-loading-overlay">
        ...
        <p>Syncing bank ledger statement...</p>
      </div>
      ...
      <table class="data-table">
        ...
        <tbody>
          <tr v-if="filteredRecords.length === 0">
            <td colspan="6" class="empty-table-row">No bank records found.</td>
          </tr>
          <tr v-for="record in filteredRecords" :key="record.id" class="table-row">
            <td class="bold-text monospace">{{ record.transactionId }}</td>
            ...
            <td class="amount-cell bold-text">{{ formatCurrency(record.balance) }}</td>
